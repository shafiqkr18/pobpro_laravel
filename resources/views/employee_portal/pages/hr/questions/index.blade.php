...
<div class="card candidate">
	...
	<div class="card-body bg-white p-4 border-0">

		<div class="row">
			<div class="col-sm-8 border-right pr-4 pl-4">
				<div class="form-group mb-0">
					<h6 class="card-header text-dark pl-0 border-0">
				...
				<div class="row mb-4">
					<div class="col-md-12">
						<div class="form-group">
							<a href="javascript:void(0)" id="save_question" class="btn btn-primary pr-4 rounded pl-4 btn-sm pull-right" data-status="1">Submit</a>
						</div>
				...
				<div class="form-group mb-0">
					...
					@endforeach
				@else
				<p class="m-0 pt-3 pb-3 pt-3 pl-0">You currently do not have any questions.</p>
				@endif
				</div>

			</div>

			<div class="col-sm-4 pl-5 pr-4 bg-white">
				<h6 class="card-header text-dark pl-3 border-0">
					FAQs
				</h6>
