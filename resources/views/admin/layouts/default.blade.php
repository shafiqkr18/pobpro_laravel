...
<head>
	...
	<link href="{{ URL::asset('css/address-book.css') }}" rel="stylesheet">
	<link href="{{ URL::asset('css/new-design.css') }}" rel="stylesheet">
...
<body>
		<div id="wrapper">
			...
			@include('admin.layouts.includes.page-wrapper')
		</div>
		...
		<script src="{{ URL::asset('js/admin.js?v=') }}{{rand(111,999)}}"></script>
</body>
</html>