  ...
  <script>
	  ...
	  window.onload = function () {
		  ...
		  $bulkDeleteBtn.click(function () {
			  console.log('clicked');
			  var ids = [];
			  var $checkedBoxes = $('#shortlisted_candidates_list input[type=checkbox]:checked').not('.select_all');
			...
			<div class="ibox ">
				...
				<div class="ibox-content">
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover " id="shortlisted_candidates_list" >
							<thead>
								<tr>
	...
	<div class="modal-dialog">
		<div class="modal-content animated fadeIn">
			...
			<div class="modal-body">
				<p><strong>Are you sure you want to call these candidates for interview?!</p>
			</div>
