...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		<div class="col-lg-12">
            ...
            <input type="hidden" id="gm_app" name="gm_app" value="{{$gm_app}}">
			<div class="ibox ">
				...
				<div class="ibox-content">
					<div class="table-responsive">
						<table class="table table-bordered table-hover" id="offer_list" style="width: 100%">
							<thead>
								<tr>
            ...
            <button  id="bulk_offer_btn"type="button" class="btn btn-primary btm-sm float-right mt-3" data-toggle="modal" data-target="#mdlOffer">
                Send Offer
            </button>
		</div>
	</div>
