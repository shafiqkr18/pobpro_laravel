						...
						<div class="row">
							<div class="col-sm-8 b-r">
								...
								<div class="form-group form-inline">
									...
									<input type="text" class="form-control form-control-sm" name="template_name" id="template_name" value="{{ $template->template_name }}">
								</div>

								<div class="form-group form-inline">
									<label>Subject</label>
									<input type="text" class="form-control form-control-sm" name="subject" id="subject" value="{{ $template->subject }}">
								</div>
