...
<div class="wrapper wrapper-content animated fadeInRight">
	<form role="form" id="frm_template" enctype="multipart/form-data">
		...
		<input type="hidden" name="listing_id" value="{{ $rotation->id }}">
							...
							<div class="row">
								<div class="col-sm-6 b-r">
									<div class="form-group form-inline">
										<label>Title</label>
										<input type="text" class="form-control form-control-sm" name="title" id="title" value="{{ $rotation->title }}">
									</div>
								</div>
									...
									<div class="form-group form-inline">
										...
										<select name="company_id" id="company_id" class="form-control form-control-sm">
											@if ($companies)
												...
												<option value="{{ $company->id }}" {{ $rotation->company_id == $company->id ? 'selected' : '' }}>{{ $company->company_name }}</option>
												@endforeach
											@endif
										</select>
									</div>
