...
Dropzone.options.dropzoneForm = {
	url:baseUrl + '/admin/contracts-mgt/contractor/import_excel',
		...
		<div class="col-lg-12">
			<div class="ibox ">
				...
				<div class="ibox-content">
                    ...
                    <p class="text-center text-secondary mt-4 mb-1">The file you upload must be a valid Excel file. (<a href="{{url('public/samples/contracts/contractorSample.xlsx')}}" class="text-success">Download sample</a>)</p>
					<p class="text-center text-secondary mb-2">All imports must be uploaded using the correct template file.</p>

					<div class="d-flex justify-content-center">
						<a href="{{ url('admin/contracts-mgt/contractors') }}" class="d-flex align-items-center p-2 text-muted">
