					...
					<form role="form" id="frm_contractor_employee" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group form-inline">
									...
									<input type="text" class="form-control form-control-sm" name="first_name" id="first_name" value="{{ $employee->first_name }}">
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group form-inline">
									...
									<input type="text" class="form-control form-control-sm" name="last_name" id="last_name" value="{{ $employee->last_name }}">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group form-inline">
									<label>Email</label>
									<input type="email" class="form-control form-control-sm" name="email" id="email" value="{{ $employee->email }}">
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group form-inline">
									<label>Phone</label>
									<input type="number" class="form-control form-control-sm" name="phone" id="phone" value="{{ $employee->phone }}">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group form-inline">
									...
									<select name="contractor_id" id="contractor_id" class="form-control form-control-sm" value="{{ $employee->contractor_id }}">
										@if ($contractor)
							...
							<div class="col-sm-6">
								<div class="form-group form-inline">
									...
									<input type="text" class="form-control form-control-sm" name="position" id="position" value="{{ $employee->position }}">
								</div>
							</div>
						</div>

						@php 
						$file = $employee && $employee->avatar ? json_decode($employee->avatar, true) : null;
						@endphp
