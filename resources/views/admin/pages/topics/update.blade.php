...
<div class="wrapper wrapper-content animated fadeInRight">
	<form id="frm_topic">
		<input type="hidden" name="listing_id" value="{{ $topic->id }}">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group form-inline">
									<label>Title: </label>
									<input type="text" class="form-control form-control-sm" name="title" id="title" value="{{ $topic->title }}">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group form-inline">
									...
									<div class="summernote">{!! $topic->contents !!}</div>
							...
							<div class="col-lg-12">
								<div class="form-group form-inline">
									...
									@if ($tasks)
										...
										<option value="{{ $task->id }}" {{ in_array($task->id, $topic->tasks->pluck('task_id')->all()) ? 'selected' : '' }}>{{ $task->title }}</option>
										@endforeach
									@endif
									</select>
								</div>
